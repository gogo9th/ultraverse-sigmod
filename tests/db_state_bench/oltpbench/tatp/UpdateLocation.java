...
//        "UPDATE " + TATPConstants.TABLENAME_SUBSCRIBER + " SET vlr_location = ? WHERE s_id = (SELECT s_id FROM " + TATPConstants.TABLENAME_SUBSCRIBER + " WHERE sub_nbr = ?)"
        "UPDATE " + TATPConstants.TABLENAME_SUBSCRIBER + " SET vlr_location = ? WHERE s_id = ? AND (SELECT s_id FROM " + TATPConstants.TABLENAME_SUBSCRIBER + " WHERE s_id = ? and sub_nbr = ?) >= 0"
    );

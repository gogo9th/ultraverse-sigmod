...
NewOrder_Label:BEGIN
  ...
  WHERE C_W_ID = var_w_id AND C_D_ID = var_d_id AND C_ID = var_c_id) < 1) THEN
    ...
    INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'NewOrder', JSON_OBJECT('var_w_id', var_w_id, 'var_c_id', var_c_id, 'var_d_id', var_d_id, 'var_o_ol_cnt', var_o_ol_cnt, 'var_ol_supply_w_id', var_ol_supply_w_id), JSON_OBJECT('var_s_quantity', var_s_quantity, 'var_o_all_local', var_o_all_local, 'var_d_next_o_id', var_d_next_o_id, 'var_loop_cnt', var_loop_cnt, 'var_i_id', var_i_id, 'var_ol_quantity', var_ol_quantity, 'var_s_dist_info', var_s_dist_info, 'var_s_remote_cnt_increment', var_s_remote_cnt_increment, 'var_i_price', var_i_price));
    LEAVE NewOrder_Label;
  ELSEIF ((SELECT COUNT(*) FROM warehouse WHERE W_ID = var_w_id) < 1) THEN
    SELECT "Error: the warehouse is not found";
    INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'NewOrder', JSON_OBJECT('var_w_id', var_w_id, 'var_c_id', var_c_id, 'var_d_id', var_d_id, 'var_o_ol_cnt', var_o_ol_cnt, 'var_ol_supply_w_id', var_ol_supply_w_id), JSON_OBJECT('var_loop_cnt', var_loop_cnt, 'var_i_id', var_i_id, 'var_ol_quantity', var_ol_quantity, 'var_s_dist_info', var_s_dist_info, 'var_s_remote_cnt_increment', var_s_remote_cnt_increment, 'var_i_price', var_i_price, 'var_s_quantity', var_s_quantity, 'var_o_all_local', var_o_all_local, 'var_d_next_o_id', var_d_next_o_id));
    LEAVE NewOrder_Label;
  END IF;
  ...
  INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'NewOrder', JSON_OBJECT('var_w_id', var_w_id, 'var_c_id', var_c_id, 'var_d_id', var_d_id, 'var_o_ol_cnt', var_o_ol_cnt, 'var_ol_supply_w_id', var_ol_supply_w_id), JSON_OBJECT('var_s_remote_cnt_increment', var_s_remote_cnt_increment, 'var_i_price', var_i_price, 'var_s_quantity', var_s_quantity, 'var_o_all_local', var_o_all_local, 'var_d_next_o_id', var_d_next_o_id, 'var_loop_cnt', var_loop_cnt, 'var_i_id', var_i_id, 'var_ol_quantity', var_ol_quantity, 'var_s_dist_info', var_s_dist_info));
END//
DELIMITER ;
...
Payment_Label:BEGIN
  ...
  IF (var_w_name IS NULL) THEN
    ...
    INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'Payment', JSON_OBJECT('var_w_id', var_w_id, 'var_d_id', var_d_id, 'var_customerDistrictID', var_customerDistrictID, 'var_customerWarehouseID', var_customerWarehouseID, 'var_c_id', var_c_id, 'var_paymentAmount', var_paymentAmount), JSON_OBJECT('var_c_credit', var_c_credit, 'var_w_name', var_w_name, 'var_d_name', var_d_name, 'var_x', var_x, 'var_c_balance', var_c_balance, 'var_c_ytd_payment', var_c_ytd_payment, 'var_c_payment_cnt', var_c_payment_cnt, 'var_c_data', var_c_data));
    LEAVE Payment_Label;
  END IF;
  ...
  IF (var_d_name IS NULL) THEN
    ...
    INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'Payment', JSON_OBJECT('var_w_id', var_w_id, 'var_d_id', var_d_id, 'var_customerDistrictID', var_customerDistrictID, 'var_customerWarehouseID', var_customerWarehouseID, 'var_c_id', var_c_id, 'var_paymentAmount', var_paymentAmount), JSON_OBJECT('var_c_balance', var_c_balance, 'var_c_ytd_payment', var_c_ytd_payment, 'var_c_payment_cnt', var_c_payment_cnt, 'var_c_data', var_c_data, 'var_c_credit', var_c_credit, 'var_w_name', var_w_name, 'var_d_name', var_d_name, 'var_x', var_x));
    LEAVE Payment_Label;
  END IF;
...
Delivery_Label:BEGIN
  ...
  INSERT INTO __ULTRAVERSE_PROCEDURE_HINT (callid, procname, args, vars) VALUES (UUID_SHORT(), 'Delivery', JSON_OBJECT('var_w_id', var_w_id, 'var_terminalDistrictLowerID', var_terminalDistrictLowerID, 'var_terminalDistrictUpperID', var_terminalDistrictUpperID, 'va_o_carrier_id', va_o_carrier_id), JSON_OBJECT('var_ol_total', var_ol_total, 'var_d_id', var_d_id, 'var_no_o_id', var_no_o_id, 'var_o_c_id', var_o_c_id, 'var_o_carrier_id', var_o_carrier_id));
END//
DELIMITER ;
